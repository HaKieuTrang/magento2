...
angular.module('readiness-check', ['remove-dialog'])
    ...
    .controller('readinessCheckController', ['$rootScope', '$scope', '$localStorage', '$http', '$timeout', '$sce', '$state', 'COUNTER', 'ngDialog', function ($rootScope, $scope, $localStorage, $http, $timeout, $sce, $state, COUNTER, ngDialog) {
        ...
        switch ($state.current.type) {
            case 'uninstall':
                $scope.dependencyUrl = 'AddMovie.php/dependency-check/uninstall-dependency-check';
            ...
            case 'disable':
                ...
                $scope.dependencyUrl = 'AddMovie.php/dependency-check/enable-disable-dependency-check';
                if ($localStorage.packages) {
                ...
                break;
            default:
                $scope.dependencyUrl = 'AddMovie.php/dependency-check/component-dependency';
                if ($localStorage.packages) {
                    $scope.componentDependency.packages = $localStorage.packages;
                }
        }
        ...
        $scope.items = {
            'php-settings': {
                url:'AddMovie.php/environment/php-settings',
            ...
            'php-extensions': {
                url:'AddMovie.php/environment/php-extensions',
                params: $scope.actionFrom,
                useGet: true,
                show: function() {
                    $scope.startProgress();
        ...
        if ($scope.actionFrom === 'installer') {
            $scope.items['php-version'] = {
                url:'AddMovie.php/environment/php-version',
                params: $scope.actionFrom,
                useGet: true,
                show: function() {
                    $scope.startProgress();
            ...
            $scope.items['file-permissions'] = {
                url:'AddMovie.php/environment/file-permissions',
                show: function() {
                    $scope.startProgress();
        ...
        if ($scope.actionFrom === 'updater') {
            $scope.items['updater-application'] = {
                url:'AddMovie.php/environment/updater-application',
                show: function() {
                    $scope.startProgress();
            ...
            $scope.items['cron-script'] = {
                url:'AddMovie.php/environment/cron-script',
                show: function() {
                    $scope.startProgress();
