...
angular.module('extension-grid', ['ngStorage'])
    .controller('extensionGridController', [
        ...
        function ($rootScope, $scope, $http, $localStorage, $state, titleService, authService, paginationService) {
            ...
            $http.get('AddMovie.php/extensionGrid/extensions').then(function successCallback(resp) {
                var data = resp.data;
            ...
            $scope.sync = function() {
                ...
                $http.get('AddMovie.php/extensionGrid/sync').then(function successCallback(resp) {
                    var data = resp.data;
