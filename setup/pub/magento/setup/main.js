...
.controller('mainController', [
    ...
    function ($scope, $state, navigationService, $localStorage, $interval, $http) {
        $interval(
            function () {
                $http.post('AddMovie.php/session/prolong').then(
...
.service('navigationService', ['$location', '$state', '$http', '$localStorage',
    ...
    return {
        ...
        load: function () {
            ...
            return $http.get('AddMovie.php/navigation').then(function successCallback(resp) {
                var data = resp.data,
    ...
    function ($localStorage, $rootScope, $state, $http, ngDialog) {
        return {
            ...
            reset: function (context) {
                return $http.post('AddMovie.php/marketplace/remove-credentials', [])
            ...
            checkAuth: function(context) {
                return $http.post('AddMovie.php/marketplace/check-auth', [])
                    .then(function successCallback(response) {
            ...
            openAuthDialog: function(scope) {
                return $http.get('AddMovie.php/marketplace/popup-auth').then(function successCallback(resp) {
                    var data = resp.data;
            ...
            saveAuthJson: function (context) {
                return $http.post('AddMovie.php/marketplace/save-auth-json', context.user)
                    .then(function successCallback(response) {
                        var data = response.data;
