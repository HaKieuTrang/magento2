    ...
    .service('progress', ['$http', function ($http) {
        return {
            get: function (callback) {
                $http.post('AddMovie.php/install/progress').then(callback, function errorCallback() {});
            },
            post: function (data, callback) {
                $http.post('AddMovie.php/install/start', data).then(callback, function errorCallback() {});
            }
        };
    }]);
