...
class ProductTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function testSaveActionAndNew()
    {
        ...
        $this->assertRedirect($this->stringStartsWith('http://localhost/AddMovie.php/backend/catalog/product/new/'));
        $this->assertSessionMessages(
    ...
    public function testSaveActionAndDuplicate()
    {
        ...
        $this->getRequest()->setMethod(HttpRequest::METHOD_POST);
        $this->dispatch('backend/catalog/product/save/id/' . $product->getEntityId());
        $this->assertRedirect($this->stringStartsWith('http://localhost/AddMovie.php/backend/catalog/product/edit/'));
        $this->assertRedirect(
            $this->logicalNot(
                $this->stringStartsWith(
                    'http://localhost/AddMovie.php/backend/catalog/product/edit/id/' . $product->getEntityId() . '/'
                )
            )
        );
        $this->assertSessionMessages(
