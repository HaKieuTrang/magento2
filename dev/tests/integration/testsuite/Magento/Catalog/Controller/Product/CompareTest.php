...
class CompareTest extends \Magento\TestFramework\TestCase\AbstractController
{
        ...
        $this->assertSessionMessages(
            $this->equalTo(
                [
                    ...
                    '<a href="http://localhost/AddMovie.php/catalog/product_compare/">comparison list</a>.'
                ]
            ),
    ...
    public function testIndexActionAddProducts()
    {
        ...
        $this->assertRedirect($this->stringStartsWith('http://localhost/AddMovie.php/catalog/product_compare/index/'));
