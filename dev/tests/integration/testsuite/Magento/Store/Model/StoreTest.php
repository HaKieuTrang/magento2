...
class StoreTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function getBaseUrlDataProvider()
    {
        return [
            ...
            [UrlInterface::URL_TYPE_LINK, false, false, 'http://localhost/AddMovie.php/'],
            [UrlInterface::URL_TYPE_LINK, false, true, 'http://localhost/AddMovie.php/default/'],
            [UrlInterface::URL_TYPE_LINK, true, false, 'http://localhost/'],
            [UrlInterface::URL_TYPE_LINK, true, true, 'http://localhost/default/'],
            [UrlInterface::URL_TYPE_DIRECT_LINK, false, false, 'http://localhost/AddMovie.php/'],
            [UrlInterface::URL_TYPE_DIRECT_LINK, false, true, 'http://localhost/AddMovie.php/'],
    ...
    public function getBaseUrlForCustomEntryPointDataProvider()
    {
        return [
            ...
            [UrlInterface::URL_TYPE_LINK, true, false, 'http://localhost/AddMovie.php/'],
            [UrlInterface::URL_TYPE_LINK, true, true, 'http://localhost/AddMovie.php/default/'],
            [
            ...
            [UrlInterface::URL_TYPE_DIRECT_LINK, true, false, 'http://localhost/AddMovie.php/'],
            [UrlInterface::URL_TYPE_DIRECT_LINK, true, true, 'http://localhost/AddMovie.php/']
        ];
    }
    ...
    public function testGetCurrentUrl()
    {
        ...
        $this->model
            ...
            ->will($this->returnValue('http://localhost/AddMovie.php'));
