...
class UrlTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals('http://localhost/AddMovie.php/', $this->model->getBaseUrl());
    }
    ...
    public function testGetUnsecureUrlInSecureArea()
    {
        ...
        $this->assertEquals(
            'https://sample.com/AddMovie.php/some/index/controller/',
            $secureUrl,
        ...
        $this->assertEquals(
            'http://sample.com/AddMovie.php/some/index/controller/',
            $unsecureUrl,
    ...
    public function testGetBaseUrlWithTypeRestoring()
    {
         ...
         */
        $this->assertEquals('http://localhost/AddMovie.php/', $this->model->getBaseUrl(), 'Incorrect link url');
    ...
    public function getBaseUrlConfiguredDataProvider()
    {
        return [
            ...
            [
                ...
                'http://sample.com/base_link_path/AddMovie.php/'
            ],
            [
                ['_type' => \Magento\Framework\UrlInterface::URL_TYPE_LINK, '_secure' => 1],
                'https://sample.com/base_link_path/AddMovie.php/'
            ]
        ];
    }
    ...
    {
        $this->assertEquals('http://localhost/AddMovie.php/', $this->model->getRouteUrl());
        $this->assertEquals(
            'http://localhost/AddMovie.php/catalog/product/view/id/50/',
            $this->model->getRouteUrl('catalog/product/view', ['id' => 50])
        );
        $this->assertEquals(
            'http://localhost/AddMovie.php/fancy_uri',
    ...
    public function testGetUrl()
    {
        ...
        $this->assertEquals('http://localhost/AddMovie.php/catalog/product/view/id/100/?foo=bar#anchor', $result);
    }
    ...
    public function testGetUrlDoesntAddQueryParamsOnConsequentCalls()
    {
        ...
        $this->assertEquals('http://localhost/AddMovie.php/catalog/product/view/?foo=bar', $result);
        $result = $this->model->getUrl('catalog/product/view', ['_nosid' => 1]);
        $this->assertEquals('http://localhost/AddMovie.php/catalog/product/view/', $result);
    }
    ...
    public function testGetUrlDoesntAddFragmentOnConsequentCalls()
    {
        ...
        $this->assertEquals('http://localhost/AddMovie.php/catalog/product/view/#section', $result);
        $result = $this->model->getUrl('catalog/product/view', ['_nosid' => 1]);
        $this->assertEquals('http://localhost/AddMovie.php/catalog/product/view/', $result);
    }
    ...
    public function consequentCallsDataProvider()
    {
        return [
            [
                ...
                null,
                null,
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
                ...
                null,
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_2/'
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
                'r_1/c_1/a_1/p_1',
                ...
                null,
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
                'http://localhost/AddMovie.php/r_1/c_1/a_1/'
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
                'r_1/c_1/a_1/p_2/v_2',
                ...
                null,
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_2/v_2/'
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
                'r_1/c_1/a_1',
            ...
            [
                ...
                null,
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
                'http://localhost/AddMovie.php/r_1/c_1/a_2/'
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
                'r_1/c_1',
                ...
                null,
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
                'http://localhost/AddMovie.php/r_1/c_1/'
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
                'r_1/c_2',
                ...
                null,
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
                'http://localhost/AddMovie.php/r_1/c_2/'
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
                'r_1',
                ...
                null,
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
                'http://localhost/AddMovie.php/r_1/'
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
                'r_2',
                ...
                null,
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/',
                'http://localhost/AddMovie.php/r_2/'
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
                null,
            ...
            [
                ...
                ['p_2' => 'v_2'],
                ['p_2' => 'v_2'],
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/p_2/v_2/',
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/p_2/v_2/'
            ],
            [
                'r_1/c_1/a_1/p_1/v_1',
            ...
            [
                ...
                ['p_1' => 'v_1', 'p_2' => 'v_2'],
                'http://localhost/AddMovie.php/r_1/c_1/a_1/p_1/v_1/p_2/v_2/',
                'http://localhost/AddMovie.php/p_1/v_1/p_2/v_2/'
            ]
        ];
    }
    ...
    public function testGetDirectUrl()
    {
        ...
        $this->assertEquals('http://localhost/AddMovie.php/fancy_uri?foo=bar', $directUrl);
    }
