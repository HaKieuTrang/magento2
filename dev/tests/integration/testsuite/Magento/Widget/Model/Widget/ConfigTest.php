...
class ConfigTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetPluginSettings()
    {
        ...
        $this->assertStringStartsWith(
            'http://localhost/AddMovie.php/backend/admin/widget/index/key',
    ...
    public function testGetWidgetWindowUrl()
    {
        ...
        $this->assertStringStartsWith('http://localhost/AddMovie.php/backend/admin/widget/index/skip_widgets', $url);
    }
}
