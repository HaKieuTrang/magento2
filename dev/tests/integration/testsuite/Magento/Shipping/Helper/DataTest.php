    ...
    public function getTrackingPopupUrlBySalesModelDataProvider()
    {
        return [
            [\Magento\Sales\Model\Order::class,
                ...
                42,
                'abc',
                'http://localhost/AddMovie.php/shipping/tracking/popup?hash=b3JkZXJfaWQ6NDI6YWJj',
            ],
            [\Magento\Sales\Model\Order\Shipment::class,
                'setId',
                42,
                'abc',
                'http://localhost/AddMovie.php/shipping/tracking/popup?hash=c2hpcF9pZDo0MjphYmM%2C'
            ],
            [\Magento\Sales\Model\Order\Shipment\Track::class,
                'setEntityId',
                42,
                'abc',
                'http://localhost/AddMovie.php/shipping/tracking/popup?hash=dHJhY2tfaWQ6NDI6YWJj'
            ]
        ];
    }
}
